...
import {SafeMath} from "@openzeppelin/contracts-legacy/math/SafeMath.sol";
    ...
    function upgrade() external onlyOwner {
        ...
        require(
            keccak256(bytes(name)) == keccak256(bytes(v2_1.name()))
                ...
                && masterMinter == v2_1.masterMinter() && owner == v2_1.owner() && pauser == v2_1.pauser()
        ...
        require(
            v2_1.approve(address(v2_1Helper), 1e5) && v2_1.allowance(address(this), address(v2_1Helper)) == 1e5
                ...
                && v2_1.allowance(address(this), msg.sender) == 0 && v2_1.balanceOf(msg.sender) == callerBal.add(2e5)
